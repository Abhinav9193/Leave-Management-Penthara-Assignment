  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="h-40 relative flex items-center justify-center mb-6">
        <img src={dashBg} alt="header" className="absolute inset-0 w-full h-full object-cover opacity-50" />
        <h2 className="relative text-3xl font-bold dark:text-white">Leave Dashboard</h2>
      </div>
